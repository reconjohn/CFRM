...
ka = function(a,c,d) {
    kable(a, format = "latex", caption = c, booktabs = T) %>%
...
kable(knn, format = "latex", caption = "Test accuracy, compared KNN with 
...
kable(com, format = "latex", caption = "Test accuracy, compared", booktabs = T) %>%
  kable_styling(latex_options = c("hold_position"))  %>%
  kable_styling(latex_options = "striped")
```
...
kable(e, format = "latex", caption = "Test accuracy, compared", booktabs = T) %>%
  kable_styling(latex_options = c("hold_position"))  %>%
  kable_styling(latex_options = "striped") %>%
